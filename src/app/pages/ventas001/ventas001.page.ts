  ...
  cargaDatos( data ) {
    ...
    if ( rs === undefined || rs.length === 0 ) {
      ...
      rs.forEach( element => {
        ...
        titx = this.funciones.nombreMes( rs[0].mes ) + '/' + (element.peri0 + 2000).toString();
        tit0 = this.funciones.nombreMes( rs[0].mes, true ) + '/' + element.peri0.toString();
        tit1 = this.funciones.nombreMes( rs[0].mes, true ) + '/' + element.peri1.toString();
        // matriz para barras
      ...
      const options   = { title: 'Mes actual : ' + titx,
                        'width': '100%',
                        'height': '100%',
                        'is3D': true,
